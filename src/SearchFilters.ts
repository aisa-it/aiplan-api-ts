...
export class SearchFilters<SecurityDataType = unknown> extends HttpClient<SecurityDataType>  {
 ...
 * @secure
 */
createSearchFilter: (data: DtoSearchFilterLight, params: RequestParams = {}) =>
 ...
 * @secure
 */
updateSearchFilter: (filterId: string, data: DtoSearchFilterLight, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
        path: `/api/auth/filters/${filterId}/`,
        method: 'PATCH',
