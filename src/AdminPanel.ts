...
export class AdminPanel<SecurityDataType = unknown> extends HttpClient<SecurityDataType>  {
 ...
 * @secure
 */
getWorkspaceProjectList: (workspaceId: string, query?: {
  /**
   * Смещение для пагинации
   * @default 0
   */
 ...
 * @secure
 */
updateReleaseNote: (noteId: string, data: DtoReleaseNoteLight, params: RequestParams = {}) =>
...
createUserTariff: (tariff: DtoTariffication, params: RequestParams = {}) =>
    this.request<DtoTariffication, ApierrorsDefinedError>({
        path: `/api/auth/admin/tariffication/`,
        method: 'POST',
                body: tariff,        secure: true,        type: ContentType.Json,        format: "json",        ...params,
    }),            /**
 ...
 * @secure
 */
updateUserTariff: (userId: string, tariff: DtoTariffication, params: RequestParams = {}) =>
    this.request<DtoTariffication, ApierrorsDefinedError>({
        path: `/api/auth/admin/tariffication/${userId}`,
        method: 'PUT',
                body: tariff,        secure: true,        type: ContentType.Json,        format: "json",        ...params,
 ...
 * @secure
 */
createMessageForMember: (data: AiplanRequestMessage, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
 ...
 * @secure
 */
updateUser: (userId: string, data: Record<string,any>, params: RequestParams = {}) =>
    this.request<DtoUserLight, ApierrorsDefinedError>({
        path: `/api/auth/admin/users/${userId}`,
        method: 'PATCH',
                body: data,        secure: true,        type: ContentType.Json,        format: "json",        ...params,
 ...
 * @secure
 */
geWorkspaceListByUser: (userId: string, query?: {
  /**
   * Смещение для пагинации
   * @default 0
   */
 ...
 * @secure
 */
getProjectListByUser: (userId: string, workspaceId: string, query?: {
  /**
   * Смещение для пагинации
   * @default 0
   */
 ...
 */
authAdminUsersWorkspacesMemberCreate: (workspaceId: string, userId: string, body: AiplanRoleUpdRequest, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
 ...
 */
authAdminUsersWorkspacesMemberDelete: (workspaceId: string, userId: string, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
        path: `/api/auth/admin/users/${userId}/workspaces/${workspaceId}/member/`,
        method: 'DELETE',
 ...
 */
authAdminUsersWorkspacesProjectsMemberCreate: (workspaceId: string, userId: string, projectId: string, body: AiplanRoleUpdRequest, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
 ...
 */
authAdminUsersWorkspacesProjectsMemberDelete: (workspaceId: string, userId: string, projectId: string, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
        path: `/api/auth/admin/users/${userId}/workspaces/${workspaceId}/projects/${projectId}/member/`,
        method: 'DELETE',
                                type: ContentType.Json,                ...params,
