...
> extends HttpClient<SecurityDataType> {
  workspace = {
     ...
     * @secure
     */
    getLastVisitedWorkspace: (requestParams: RequestParams = {}) =>
     ...
     * @secure
     */
    getFavoriteWorkspaceList: (requestParams: RequestParams = {}) =>
     ...
     * @secure
     */
    getWorkspace: (workspaceSlug: string, requestParams: RequestParams = {}) =>
      this.request<DtoWorkspace, ApierrorsDefinedError>({
  ...
  adminPanel = {
     ...
     * @secure
     */
    exportFeedbackList: (requestParams: RequestParams = {}) =>
      this.request<void, ApierrorsDefinedError>({
     ...
     * @secure
     */
    getRunningImportList: (requestParams: RequestParams = {}) =>
     ...
     * @secure
     */
    deleteReleaseNote: (noteId: string, requestParams: RequestParams = {}) =>
      this.request<void, ApierrorsDefinedError>({
     ...
     * @secure
     */
    getUserTariff: (userId: string, requestParams: RequestParams = {}) =>
      this.request<DtoTariffication, ApierrorsDefinedError>({
     ...
     * @secure
     */
    deleteUserTariff: (userId: string, requestParams: RequestParams = {}) =>
      this.request<void, ApierrorsDefinedError>({
        path: `/api/auth/admin/tariffication/${userId}`,
        method: "DELETE",
        secure: true,
     ...
     * @secure
     */
    reloadTemplates: (requestParams: RequestParams = {}) =>
      this.request<void, ApierrorsDefinedError>({
     ...
     * @secure
     */
    getUserById: (userId: string, requestParams: RequestParams = {}) =>
      this.request<DtoUserLight, ApierrorsDefinedError>({
     ...
     * @secure
     */
    deleteUser: (userId: string, requestParams: RequestParams = {}) =>
      this.request<void, ApierrorsDefinedError>({
        path: `/api/auth/admin/users/${userId}`,
        method: "DELETE",
        secure: true,
     ...
     * @secure
     */
    getUserFeedback: (userId: string, requestParams: RequestParams = {}) =>
  ...
  releaseNotes = {
     ...
     * @secure
     */
    getReleaseNote: (noteId: string, requestParams: RequestParams = {}) =>
      this.request<DtoReleaseNoteLight, ApierrorsDefinedError>({
        path: `/api/auth/admin/release-notes/${noteId}`,
        method: "GET",
        secure: true,
     ...
     * @secure
     */
    getProductUpdateList: (requestParams: RequestParams = {}) =>
      this.request<DtoReleaseNoteLight[], ApierrorsDefinedError>({
  ...
  users = {
     ...
     * @secure
     */
    signOutEverywhere: (requestParams: RequestParams = {}) =>
      this.request<void, ApierrorsDefinedError>({
     ...
     * @secure
     */
    signOut: (requestParams: RequestParams = {}) =>
      this.request<void, ApierrorsDefinedError>({
     ...
     * @secure
     */
    getCurrentUser: (requestParams: RequestParams = {}) =>
     ...
     * @secure
     */
    deleteCurrentUserAvatar: (requestParams: RequestParams = {}) =>
      this.request<DtoUser, ApierrorsDefinedError>({
        path: `/api/auth/users/me/avatar/`,
        method: "DELETE",
        secure: true,
     ...
     * @secure
     */
    getMyFeedback: (requestParams: RequestParams = {}) =>
      this.request<DtoUserFeedback, ApierrorsDefinedError>({
     ...
     * @secure
     */
    deleteMyFeedback: (requestParams: RequestParams = {}) =>
      this.request<void, ApierrorsDefinedError>({
        path: `/api/auth/users/me/feedback/`,
        method: "DELETE",
        secure: true,
     ...
     * @secure
     */
    updateUserOnBoard: (data: DtoUser, requestParams: RequestParams = {}) =>
     ...
     * @secure
     */
    getMyAuthToken: (requestParams: RequestParams = {}) =>
      this.request<string, ApierrorsDefinedError>({
     ...
     * @secure
     */
    resetMyAuthToken: (requestParams: RequestParams = {}) =>
      this.request<void, ApierrorsDefinedError>({
     ...
     * @secure
     */
    getUser: (userId: string, requestParams: RequestParams = {}) =>
      this.request<DtoUserLight, ApierrorsDefinedError>({
     ...
     */
    requestCaptcha: (requestParams: RequestParams = {}) =>
     ...
     */
    emailLogin: (data: AiplanLoginRequest, requestParams: RequestParams = {}) =>
      this.request<Record<string, any>, ApierrorsDefinedError>({
        path: `/api/sign-in`,
        method: "POST",
        body: data,
  ...
  searchFilters = {
     ...
     * @secure
     */
    getSearchFilter: (filterId: string, requestParams: RequestParams = {}) =>
      this.request<DtoSearchFilterFull, ApierrorsDefinedError>({
     ...
     * @secure
     */
    deleteSearchFilter: (filterId: string, requestParams: RequestParams = {}) =>
      this.request<void, ApierrorsDefinedError>({
        path: `/api/auth/filters/${filterId}/`,
        method: "DELETE",
        secure: true,
     ...
     * @secure
     */
    getMySearchFilterList: (requestParams: RequestParams = {}) =>
      this.request<DtoSearchFilterFull[], ApierrorsDefinedError>({
  ...
  forms = {
     ...
     * @secure
     */
    getFormAuth: (formSlug: string, requestParams: RequestParams = {}) =>
     ...
     * @secure
     */
    getFormList: (workspaceSlug: string, requestParams: RequestParams = {}) =>
     ...
     */
    getFormNoAuth: (formSlug: string, requestParams: RequestParams = {}) =>
      this.request<DtoForm, ApierrorsDefinedError>({
  ...
  integrations = {
     ...
     * @secure
     */
    cancelJiraImport: (importId: string, requestParams: RequestParams = {}) =>
      this.request<void, ApierrorsDefinedError>({
     ...
     * @secure
     */
    getMyImportList: (requestParams: RequestParams = {}) =>
      this.request<Record<string, any>, ApierrorsDefinedError>({
     ...
     */
    getTgBotLink: (requestParams: RequestParams = {}) =>
  ...
  notifications = {
     ...
     * @secure
     */
    deleteMyNotifications: (requestParams: RequestParams = {}) =>
      this.request<void, ApierrorsDefinedError>({
        path: `/api/auth/users/me/notifications`,
        method: "DELETE",
        secure: true,
  ...
  sprint = {
     ...
     * @secure
     */
    getSprintList: (workspaceSlug: string, requestParams: RequestParams = {}) =>
