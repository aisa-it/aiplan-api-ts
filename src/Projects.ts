 ...
 * @secure
 */
getFilterLabelList: (data: AiplanFilterParams, query?: {
  /**
 ...
 * @secure
 */
getFilterMemberList: (data: AiplanFilterParams, query?: {
  /**
   * Смещение для пагинации
   * @default 0
   */
 ...
 * @secure
 */
getFilterStateList: (data: AiplanFilterParams, query?: {
  /**
   * Смещение для пагинации
   * @default 0
   */
 ...
 * @secure
 */
checkProjectIdentifierAvailability: (workspaceSlug: string, query: {
  /** Идентификатор проекта */
    name: string,

}, params: RequestParams = {}) =>
    this.request<AiplanCheckProjectIdentifierAvailabilityResponse, ApierrorsDefinedError>({
 ...
 * @secure
 */
getProjectList: (workspaceSlug: string, query?: {
 ...
 * @secure
 */
createProject: (workspaceSlug: string, request: AiplanCreateProjectRequest, params: RequestParams = {}) =>
 ...
 * @secure
 */
joinProjects: (workspaceSlug: string, projects: AiplanJoinProjectsRequest, params: RequestParams = {}) =>
    this.request<AiplanJoinProjectsSuccessResponse, ApierrorsDefinedError>({
        path: `/api/auth/workspaces/${workspaceSlug}/projects/join/`,
        method: 'POST',
                body: projects,        secure: true,        type: ContentType.Json,                ...params,
    }),            /**
 ...
 * @secure
 */
getProject: (workspaceSlug: string, projectId: string, params: RequestParams = {}) =>
    this.request<DtoProject, ApierrorsDefinedError>({
 ...
 * @secure
 */
deleteProject: (workspaceSlug: string, projectId: string, params: RequestParams = {}) =>
 ...
 * @secure
 */
updateProject: (workspaceSlug: string, projectId: string, project: DtoProject, params: RequestParams = {}) =>
    this.request<DtoProject, ApierrorsDefinedError>({
        path: `/api/auth/workspaces/${workspaceSlug}/projects/${projectId}`,
        method: 'PATCH',
                body: project,        secure: true,        type: ContentType.Json,        format: "json",        ...params,
    }),            /**
 ...
 * @secure
 */
getProjectActivityList: (workspaceSlug: string, projectId: string, query?: {
  /**
   * Смещение для пагинации
   * @default 0
   */
 ...
 * @secure
 */
getIssueLabelList: (workspaceSlug: string, projectId: string, query?: {
 ...
 * @secure
 */
createIssueLabel: (workspaceSlug: string, projectId: string, data: DtoLabelLight, params: RequestParams = {}) =>
    this.request<DtoLabelLight, ApierrorsDefinedError>({
        path: `/api/auth/workspaces/${workspaceSlug}/projects/${projectId}/issue-labels`,
        method: 'POST',
 ...
 * @secure
 */
getIssueLabel: (workspaceSlug: string, projectId: string, labelId: string, params: RequestParams = {}) =>
    this.request<DtoLabelLight, ApierrorsDefinedError>({
 ...
 * @secure
 */
deleteIssueLabel: (workspaceSlug: string, projectId: string, labelId: string, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
        path: `/api/auth/workspaces/${workspaceSlug}/projects/${projectId}/issue-labels/${labelId}`,
        method: 'DELETE',
                        secure: true,                        ...params,
 ...
 * @secure
 */
updateIssueLabel: (workspaceSlug: string, projectId: string, labelId: string, data: DtoLabelLight, params: RequestParams = {}) =>
    this.request<DtoLabelLight, ApierrorsDefinedError>({
        path: `/api/auth/workspaces/${workspaceSlug}/projects/${projectId}/issue-labels/${labelId}`,
        method: 'PATCH',
                body: data,        secure: true,        type: ContentType.Json,        format: "json",        ...params,
 ...
 * @secure
 */
updateProjectLogo: (workspaceSlug: string, projectId: string, data: {
  /** Файл логотипа */
    file: File,
 ...
 * @secure
 */
deleteProjectLogo: (workspaceSlug: string, projectId: string, params: RequestParams = {}) =>
    this.request<DtoProject, ApierrorsDefinedError>({
        path: `/api/auth/workspaces/${workspaceSlug}/projects/${projectId}/logo/`,
        method: 'DELETE',
                        secure: true,        type: ContentType.Json,        format: "json",        ...params,
 ...
 * @secure
 */
updateMyNotifications: (workspaceSlug: string, projectId: string, notificationSettings: AiplanProjectNotificationRequest, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
        path: `/api/auth/workspaces/${workspaceSlug}/projects/${projectId}/me/notifications/`,
        method: 'POST',
                body: notificationSettings,        secure: true,        type: ContentType.Json,                ...params,
    }),            /**
 ...
 * @secure
 */
getProjectMemberList: (workspaceSlug: string, projectId: string, query?: {
  /**
   * Смещение для пагинации
   * @default -1
   */
 ...
 * @secure
 */
addMemberToProject: (workspaceSlug: string, projectId: string, memberId: DtoProjectMember, params: RequestParams = {}) =>
    this.request<DtoProjectMemberLight, ApierrorsDefinedError>({
        ...
        method: 'POST',
                body: memberId,        secure: true,        type: ContentType.Json,                ...params,
    }),            /**
 ...
 * @secure
 */
getProjectMember: (workspaceSlug: string, projectId: string, memberId: string, params: RequestParams = {}) =>
    this.request<DtoProjectMemberLight, ApierrorsDefinedError>({
 ...
 * @secure
 */
deleteProjectMember: (workspaceSlug: string, projectId: string, memberId: string, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
        path: `/api/auth/workspaces/${workspaceSlug}/projects/${projectId}/members/${memberId}`,
        method: 'DELETE',
                        secure: true,                        ...params,
 ...
 * @secure
 */
updateProjectMember: (workspaceSlug: string, projectId: string, memberId: string, role: Record<string,number>, params: RequestParams = {}) =>
    this.request<DtoProjectMemberLight, ApierrorsDefinedError>({
        path: `/api/auth/workspaces/${workspaceSlug}/projects/${projectId}/members/${memberId}`,
        method: 'PATCH',
 ...
 * @secure
 */
getProjectMemberMe: (workspaceSlug: string, projectId: string, params: RequestParams = {}) =>
 ...
 * @secure
 */
updateProjectView: (workspaceSlug: string, projectId: string, view_props: TypesViewProps, params: RequestParams = {}) =>
    this.request<string, ApierrorsDefinedError>({
        path: `/api/auth/workspaces/${workspaceSlug}/projects/${projectId}/project-views/`,
        method: 'POST',
                body: view_props,        secure: true,        type: ContentType.Json,                ...params,
    }),            /**
 ...
 * @secure
 */
getRulesLog: (workspaceSlug: string, projectId: string, data: AiplanGetRulesLogfilterRequest, query?: {
  /**
   * Смещение для пагинации
   * @default -1
   */
 ...
 * @secure
 */
getStateList: (workspaceSlug: string, projectId: string, query?: {
 ...
 * @secure
 */
createState: (workspaceSlug: string, projectId: string, data: DtoStateLight, params: RequestParams = {}) =>
 ...
 * @secure
 */
getState: (workspaceSlug: string, projectId: string, stateId: string, params: RequestParams = {}) =>
    this.request<DtoStateLight, ApierrorsDefinedError>({
 ...
 * @secure
 */
deleteState: (workspaceSlug: string, projectId: string, stateId: string, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
        path: `/api/auth/workspaces/${workspaceSlug}/projects/${projectId}/states/${stateId}`,
        method: 'DELETE',
                        secure: true,                        ...params,
 ...
 * @secure
 */
updateState: (workspaceSlug: string, projectId: string, stateId: string, data: AiplanUpdateStateRequest, params: RequestParams = {}) =>
    this.request<DtoStateLight, ApierrorsDefinedError>({
        path: `/api/auth/workspaces/${workspaceSlug}/projects/${projectId}/states/${stateId}`,
        method: 'PATCH',
                body: data,        secure: true,        type: ContentType.Json,        format: "json",        ...params,
 ...
 * @secure
 */
getProjectIssueTemplates: (workspaceSlug: string, projectId: string, query?: {
  /**
   * Смещение для пагинации
   * @default -1
   */
 ...
 * @secure
 */
createIssueTemplate: (workspaceSlug: string, projectId: string, data: DtoIssueTemplate, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
        path: `/api/auth/workspaces/${workspaceSlug}/projects/${projectId}/templates`,
        method: 'POST',
 ...
 * @secure
 */
getIssueTemplate: (workspaceSlug: string, projectId: string, templateId: string, params: RequestParams = {}) =>
 ...
 * @secure
 */
deleteIssueTemplate: (workspaceSlug: string, projectId: string, templateId: string, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
        path: `/api/auth/workspaces/${workspaceSlug}/projects/${projectId}/templates/${templateId}`,
        method: 'DELETE',
                        secure: true,        type: ContentType.Json,                ...params,
 ...
 * @secure
 */
updateIssueTemplate: (workspaceSlug: string, projectId: string, templateId: string, data: DtoIssueTemplate, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
        path: `/api/auth/workspaces/${workspaceSlug}/projects/${projectId}/templates/${templateId}`,
        method: 'PATCH',
                body: data,        secure: true,        type: ContentType.Json,                ...params,
 ...
 * @secure
 */
addProjectToFavorites: (workspaceSlug: string, project: AiplanAddProjectToFavoritesRequest, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
        path: `/api/auth/workspaces/${workspaceSlug}/user-favorite-projects/`,
        method: 'POST',
                body: project,        secure: true,        type: ContentType.Json,                ...params,
    }),            /**
 ...
 * @secure
 */
removeProjectFromFavorites: (workspaceSlug: string, projectId: string, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
