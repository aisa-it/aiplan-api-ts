 ...
 * @secure
 */
updateMyPassword: (data: AiplanPasswordRequest, params: RequestParams = {}) =>
 ...
 */
forgotPassword: (data: AiplanEmailCaptchaRequest, params: RequestParams = {}) =>
 ...
 */
resetPassword: (uidb64: string, token: string, data: AiplanPasswordRequest, params: RequestParams = {}) =>
    this.request<AiplanPasswordResponse, ApierrorsDefinedError>({
 ...
 * @secure
 */
resetUserPassword: (uidb64: string, data: AiplanPasswordRequest, params: RequestParams = {}) =>
    this.request<AiplanPasswordResponse, ApierrorsDefinedError>({
 ...
 * @secure
 */
getUserActivityList: (userId: string, query?: {
  /**
 ...
 * @secure
 */
updateCurrentUser: (data: AiplanUserUpdateRequest, params: RequestParams = {}) =>
    this.request<DtoUser, ApierrorsDefinedError>({
        path: `/api/auth/users/me/`,
        method: 'PATCH',
                body: data,        secure: true,        type: ContentType.Json,        format: "json",        ...params,
 ...
 * @secure
 */
getCurrentUserAllProjectList: (query?: {
 ...
 * @secure
 */
createMyFeedback: (data: AiplanPostFeedbackRequest, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
        path: `/api/auth/users/me/feedback/`,
        method: 'POST',
 ...
 * @secure
 */
getUserActivitiesTable: (userId: string, query: {
  /** Начальная дата периода в формате YYYY-MM-DD */
    from: string,
  /** Конечная дата периода в формате YYYY-MM-DD */
    to: string,
