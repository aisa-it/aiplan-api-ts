 ...
 * @secure
 */
deleteFormAttachment: (workspaceSlug: string, formSlug: string, attachmentId: string, params: RequestParams = {}) =>
 ...
 * @secure
 */
createRootDoc: (workspaceSlug: string, data: {
  /**
 ...
 * @secure
 */
createDoc: (workspaceSlug: string, docId: string, data: {
  /**
   * документ в формате JSON
   * @example "{"title": "title text", "content": "<p>HTML-контент</p>", "reader_role": 5, "editor_role":10, "seq_id": 0, "draft": false}"
   */
 ...
 * @secure
 */
deleteDoc: (workspaceSlug: string, docId: string, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
        path: `/api/auth/workspaces/${workspaceSlug}/doc/${docId}/`,
        method: 'DELETE',
                        secure: true,        type: ContentType.Json,                ...params,
 ...
 * @secure
 */
updateDoc: (workspaceSlug: string, docId: string, data: {
  /**
   * документ в формате JSON
   * @example "{"title": "title text", "content": "<p>HTML-контент</p>", "reader_role": 5, "editor_role":10, "seq_id": 0, "draft": false}"
   */
 ...
 * @secure
 */
getDocActivityList: (workspaceSlug: string, docId: string, query?: {
  /**
 ...
 * @secure
 */
getChildDocList: (workspaceSlug: string, docId: string, params: RequestParams = {}) =>
    this.request<(DtoDocLight)[], ApierrorsDefinedError>({
 ...
 * @secure
 */
getDocCommentList: (workspaceSlug: string, docId: string, query?: {
  /**
   * Смещение для пагинации
   * @default 0
   */
 ...
 * @secure
 */
createDocComment: (workspaceSlug: string, docId: string, data: {
  /**
 ...
 * @secure
 */
getDocComment: (workspaceSlug: string, docId: string, commentId: string, params: RequestParams = {}) =>
    this.request<DtoDocComment, ApierrorsDefinedError>({
 ...
 * @secure
 */
deleteDocComment: (workspaceSlug: string, docId: string, commentId: string, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
        path: `/api/auth/workspaces/${workspaceSlug}/doc/${docId}/comments/${commentId}/`,
        method: 'DELETE',
                        secure: true,        type: ContentType.Json,                ...params,
 ...
 * @secure
 */
updateDocComment: (workspaceSlug: string, docId: string, commentId: string, data: {
  /**
   * комментарий в формате JSON
   * @example "{"comment_html": "<p>HTML-контент</p>", "reply_to_comment_id": null}"
   */
 ...
 * @secure
 */
addDocCommentReaction: (workspaceSlug: string, docId: string, commentId: string, data: AiplanReactionRequest, params: RequestParams = {}) =>
 ...
 * @secure
 */
removeDocCommentReaction: (workspaceSlug: string, docId: string, commentId: string, reaction: string, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
 ...
 * @secure
 */
getDocAttachmentList: (workspaceSlug: string, docId: string, params: RequestParams = {}) =>
 ...
 * @secure
 */
createDocAttachments: (workspaceSlug: string, docId: string, data: {
  /** Файл для загрузки */
    asset: File,
 ...
 * @secure
 */
deleteDocAttachment: (workspaceSlug: string, docId: string, attachmentId: string, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
 ...
 * @secure
 */
getDocHistoryList: (workspaceSlug: string, docId: string, query?: {
  /**
   * Смещение для пагинации
   * @default 0
   */
 ...
 * @secure
 */
getDocHistory: (workspaceSlug: string, docId: string, versionId: string, params: RequestParams = {}) =>
 ...
 * @secure
 */
updateDocFromHistory: (workspaceSlug: string, docId: string, versionId: string, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
        path: `/api/auth/workspaces/${workspaceSlug}/doc/${docId}/history/${versionId}`,
        method: 'PATCH',
                        secure: true,        type: ContentType.Json,                ...params,
 ...
 * @secure
 */
moveDoc: (workspaceSlug: string, docId: string, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
 ...
 * @secure
 */
addDocToFavorites: (workspaceSlug: string, project: AiplanAddDocToFavoritesRequest, params: RequestParams = {}) =>
    this.request<DtoDocFavorites, ApierrorsDefinedError>({
        path: `/api/auth/workspaces/${workspaceSlug}/user-favorite-docs/`,
        method: 'POST',
 ...
 * @secure
 */
removeDocFromFavorites: (workspaceSlug: string, docId: string, params: RequestParams = {}) =>
    this.request<void, ApierrorsDefinedError>({
